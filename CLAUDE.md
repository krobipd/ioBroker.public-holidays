...
├── src/ExcludeSelector.tsx        → ConfigGeneric-Komponente: Scope aus props.data → scope-exakte Feiertagsliste (date-holidays, client-seitig), lokalisiert (I18n.getLanguage()), datums-sortiert, schreibt excludeHolidays
